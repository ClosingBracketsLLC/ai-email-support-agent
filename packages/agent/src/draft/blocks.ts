...
const PLATFORM_RULES_TEXT = [
  ...
  '  customer sent you, not one you remember, not one you assemble because it looks plausible. If the',
  '  customer needs a channel the profile does not list, say a person will follow up and escalate.',
