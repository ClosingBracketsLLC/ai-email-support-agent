...
const EXPECTED_TABLES = ['account', 'agent_category_policies', 'agent_run_events', 'agent_runs', 'agents', 'audit_log', 'categories', 'draft_action_tokens', 'drafts', 'gmail_access_requests', 'invitation', 'llm_calls', 'mailbox_connections', 'mailbox_credentials', 'member', 'messages', 'notification_devices', 'notifications', 'oauth_flows', 'org_data_keys', 'org_settings', 'organization', 'outbound_sends', 'platform_state', 'session', 'tickets', 'usage_counters', 'user', 'verification', 'webhook_events', 'workspaces']
